...
/***/ "./src/js/modules/userPage.js":
/*!************************************!*\
  !*** ./src/js/modules/userPage.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./search */ \"./src/js/modules/search.js\");\n/* harmony import */ var _assets_img_icons_star_6_16_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/img/icons/star-6-16.png */ \"./src/assets/img/icons/star-6-16.png\");\n/* harmony import */ var _assets_img_icons_student_16_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../assets/img/icons/student-16.png */ \"./src/assets/img/icons/student-16.png\");\n/* harmony import */ var _assets_img_icons_pacifier_2_16_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../assets/img/icons/pacifier-2-16.png */ \"./src/assets/img/icons/pacifier-2-16.png\");\n\r\n\r\n\r\n\r\n\r\nconst loadUserPage = (id) => {\r\n  (0,_search__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n  const searchContainer = document.querySelector('.search-bar-container');\r\n  const userPage = document.querySelector('.user-page-container');\r\n\r\n  searchContainer.classList.toggle('hidden');\r\n  userPage.classList.toggle('hidden');\r\n\r\n  const usersData = JSON.parse(localStorage.getItem('usersData')).results;\r\n  const result = usersData.filter( (user) => {\r\n    if (user.subjectId === id) {\r\n      return user;\r\n    }\r\n  });\r\n  const user = result[0];\r\n  const userPageHtml = (\r\n    `<div class=\"frame-big\"><img class=\"user-photo-big\" src=\"${user.picture}\" alt=\"${user.name}-photo\"></div>\r\n    <h2 class=\"user-page-title\">${user.name}</h2>\r\n    <h3 class=\"user-page-subtitle\">Skills and interests:</h3>\r\n    <div class=\"skill-title\"><i class=\"icon\"><img src=\"${_assets_img_icons_star_6_16_png__WEBPACK_IMPORTED_MODULE_1__}\" alt=\"icon\"></i><h4>Master / influencer</h4></div>\r\n    <ul class=\"master-skill-container\"></ul>\r\n    <div class=\"skill-title\"><i class=\"icon\"><img src=\"${_assets_img_icons_student_16_png__WEBPACK_IMPORTED_MODULE_2__}\" alt=\"icon\"></i><h4>Proeficient</h4></div>\r\n    <ul class=\"proeficient-skill-container\"></ul>\r\n    <div class=\"skill-title\"><i class=\"icon\"><img src=\"${_assets_img_icons_pacifier_2_16_png__WEBPACK_IMPORTED_MODULE_3__}\" alt=\"icon\"></i><h4>No experience, but interested</h4></div>\r\n    <ul class=\"no-skill-container\"></ul>`\r\n  );\r\n  userPage.innerHTML += userPageHtml;\r\n  for (let i = 0; i < user.skills.length; i += 1) {\r\n    const skill = user.skills[i];\r\n    if (skill.weight === 0) {\r\n      const noSkillContainer = document.querySelector('.no-skill-container');\r\n      noSkillContainer.innerHTML += `<li class=\"skill\">${skill.name}</li>`\r\n    } else if (skill.weight > 0 && skill.weight < 750) {\r\n      const proeficientSkillContainer = document.querySelector('.proeficient-skill-container');\r\n      proeficientSkillContainer.innerHTML += `<li class=\"skill\">${skill.name}</li>`\r\n    } else if (skill.weight >= 750) {\r\n      const masterSkillContainer = document.querySelector('.master-skill-container');\r\n      masterSkillContainer.innerHTML += `<li class=\"skill\">${skill.name}</li>`\r\n    }\r\n  }\r\n  window.history.pushState('', '', `https://felipeg005.github.io/${user.name}`);\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (loadUserPage);\n\n//# sourceURL=webpack://skills-website/./src/js/modules/userPage.js?");

/***/ }),

/***/ "./src/assets/img/icons/pacifier-2-16.png":
/*!************************************************!*\
  !*** ./src/assets/img/icons/pacifier-2-16.png ***!
  \************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"421ac0f1e23c7196172a.png\";\n\n//# sourceURL=webpack://skills-website/./src/assets/img/icons/pacifier-2-16.png?");

/***/ }),

/***/ "./src/assets/img/icons/star-6-16.png":
/*!********************************************!*\
  !*** ./src/assets/img/icons/star-6-16.png ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"b1721ec938135ec3819e.png\";\n\n//# sourceURL=webpack://skills-website/./src/assets/img/icons/star-6-16.png?");

/***/ }),

/***/ "./src/assets/img/icons/student-16.png":
/*!*********************************************!*\
  !*** ./src/assets/img/icons/student-16.png ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"22c967eff99c72a369d4.png\";\n\n//# sourceURL=webpack://skills-website/./src/assets/img/icons/student-16.png?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "https://felipeg005.github.io/Skills-Website/";
/******/ 	})();
/******/ 	
/************************************************************************/
/******/ 	
